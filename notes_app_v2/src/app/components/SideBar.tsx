...
export default function SideBar({
  ...
  return (
    <div
      ...
      } border-r border-gray-200 p-4 shadow-sm`}
    >
      <Folders
        folders={folders}
      ...
      <div className="space-y-3">
        {todos.map((todo) => (
          <div
            ...
            } rounded-lg shadow-sm cursor-pointer hover:bg-gray-100 transition-colors group relative border ${
              todo.completed
          ...
          >
            <div onClick={() => onSelectTodo(todo)} className="flex-1">
              ...
              {todo.category && (
                <p className="text-xs text-blue-600 mt-1">{todo.category}</p>
              )}
              {todo.dueDate && (
